...
export default function AlbionRovers ({ navigation }) {
    return (
        <Layout>
            <TopNav
            ...
            <ScrollView>
                <View style={styles.container}>
                    <View style={styles.header}>
                        <Text style={styles.clubTitle}>Albion Rovers </Text>
                        <Image style={styles.clubBadgeFormat}
                        resizeMode="contain"
                        source={require("../../../../assets/club-badges/albion-rovers.png")}/>
                    </View>
                    ...
                    <View style={{flexDirection:'row', justifyContent:'space-evenly',borderWidth:1, padding:10,backgroundColor:"yellow"}}>
                        ...
                        <View style={styles.rightView}>
                            <Text style={{color:'black'}}>Coatbridge{"\n"}</Text>
                            <Text style={{color:'black'}}>1882{"\n"}</Text>
                            <TouchableOpacity
                                onPress={() => {
                            ...
                            <Text style={{color:'black'}}>Cliftonhill Stadium{"\n"}</Text>
                            <Text style={{color:'black'}}>1,572</Text>
                        </View>
                    </View>
                    ...
                    <View style={{backgroundColor:"yellow"}}>
                        ...
                        resizeMode="contain"
                        source={require("../../../../assets/google-map-photos/albion_rovers_gm.png")}/>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={{padding:16, borderBottomWidth:1,}}>
                        <TouchableOpacity
                                onPress={() => {
                                  navigation.navigate("AlbionRoversQuery");
                                }}
                              >
