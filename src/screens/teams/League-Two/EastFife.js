...
export default function EastFife ({ navigation }) {
    return (
        <Layout>
            <TopNav
            ...
            <ScrollView>
                <View style={styles.container}>
                    <View style={styles.header}>
                        <Text style={styles.clubTitle}>East Fife F.C. </Text>
                        <Image style={styles.clubBadgeFormat}
                        resizeMode="contain"
                        source={require("../../../../assets/club-badges/east-fife.png")}/>
                    </View>
                    ...
                    <View style={{flexDirection:'row', justifyContent:'space-evenly',borderWidth:1, padding:10,backgroundColor:"yellow"}}>
                        ...
                        <View style={styles.rightView}>
                            <Text style={{color:'black'}}>Fife / Methil{"\n"}</Text>
                            <Text style={{color:'black'}}>1903{"\n"}</Text>
                            <Text>Cowdenbeath F.C. {"\n"}</Text>
                            <Text style={{color:'black'}}>Bayview Stadium{"\n"}</Text>
                            <Text style={{color:'black'}}>1,980</Text>
                        </View>
                    </View>
                    ...
                    <View style={{backgroundColor:"yellow"}}>
                        ...
                        resizeMode="contain"
                        source={require("../../../../assets/google-map-photos/east_fife.png")}/>
                        </TouchableOpacity>
                    </View>
