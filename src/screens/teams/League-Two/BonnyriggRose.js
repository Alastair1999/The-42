...
export default function BonnyriggRose ({ navigation }) {
    return (
        <Layout>
            <TopNav
            ...
            <ScrollView>
                <View style={styles.container}>
                    <View style={styles.header}>
                        <Text style={styles.clubTitle}>Bonnyrigg Rose Athletic F.C. </Text>
                        <Image style={styles.clubBadgeFormat}
                        resizeMode="contain"
                        source={require("../../../../assets/club-badges/bonnyrigg-rose.png")}/>
                    </View>
                    ...
                    <View style={{flexDirection:'row', justifyContent:'space-evenly',borderWidth:1, padding:10,backgroundColor:"red"}}>
                        ...
                        <View style={styles.rightView}>
                            <Text style={{color:'white'}}>Midlothian / Bonnyrigg{"\n"}</Text>
                            <Text style={{color:'white'}}>1881{"\n"}</Text>
                            <Text style={{color:'white'}}>None {"\n"}</Text>
                            <Text style={{color:'white'}}>New Dundas Park{"\n"}</Text>
                            <Text style={{color:'white'}}>2,640</Text>
                        </View>
                    </View>
                    ...
                    <View style={{backgroundColor:"red"}}>
                        ...
                        resizeMode="contain"
                        source={require("../../../../assets/google-map-photos/bonnyrigg_rose_gm.png")}/>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={{padding:16, borderBottomWidth:1,}}>
                        <TouchableOpacity
                                onPress={() => {
                                  navigation.navigate("BonnyriggRoseQuery");
                                }}
                              >
