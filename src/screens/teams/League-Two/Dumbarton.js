...
export default function Dumbarton ({ navigation }) {
    return (
        <Layout>
            <TopNav
            ...
            <ScrollView>
                <View style={styles.container}>
                    <View style={styles.header}>
                        <Text style={styles.clubTitle}>Dumbarton</Text>
                        <Image style={styles.clubBadgeFormat}
                        resizeMode="contain"
                        source={require("../../../../assets/club-badges/dumbarton.png")}/>
                    </View>
                    ...
                    <View style={{flexDirection:'row', justifyContent:'space-evenly',borderWidth:1, padding:10,backgroundColor:"yellow"}}>
                        ...
                        <View style={styles.rightView}>
                            <Text style={{color:'black'}}>Dumbarton{"\n"}</Text>
                            <Text style={{color:'black'}}>1872{"\n"}</Text>
                            <Text style={{color:'black'}}>Clydebank F.C.{"\n"}</Text>
                            <Text style={{color:'black'}}>Dumbarton Football Stadium{"\n"}</Text>
                            <Text style={{color:'black'}}>2,020</Text>
                        </View>
                    </View>
                    ...
                    <View style={{backgroundColor:"yellow"}}>
                        ...
                        resizeMode="contain"
                        source={require("../../../../assets/google-map-photos/dumbarton_gm.png")}/>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={{padding:16, borderBottomWidth:1,}}>
                        <TouchableOpacity
                                onPress={() => {
                                  navigation.navigate("DumbartonQuery");
                                }}
                              >
