...
export default function ForfarAthletic ({ navigation }) {
    return (
        <Layout>
            <TopNav
            ...
            <ScrollView>
                <View style={styles.container}>
                    <View style={styles.header}>
                        <Text style={styles.clubTitle}>Forfar Athletic </Text>
                        <Image style={styles.clubBadgeFormat}
                        resizeMode="contain"
                        source={require("../../../../assets/club-badges/forfar-athletic.png")}/>
                    </View>

                    <View style={{flexDirection:'row', justifyContent:'space-evenly',borderWidth:1, padding:10,backgroundColor:"#ADD8E6"}}>
                        ...
                        <View style={styles.rightView}>
                            <Text style={{color:'white'}}>Moray / Elgin{"\n"}</Text>
                            ...
                            <Text style={{color:'white'}}>Borough Briggs{"\n"}</Text>
                            <Text style={{color:'white'}}>4,520</Text>
                        </View>
                    </View>
                    ...
                    <View style={{backgroundColor:"#ADD8E6"}}>
                        ...
                        resizeMode="contain"
                        source={require("../../../../assets/google-map-photos/elgin_city_gm.png")}/>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={{padding:16, borderBottomWidth:1,}}>
                        <TouchableOpacity
                                onPress={() => {
                                  navigation.navigate("ForfarQuery");
                                }}
                              >
