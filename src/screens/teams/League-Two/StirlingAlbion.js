...
export default function StirlingAlbion ({ navigation }) {
    return (
        <Layout>
            <TopNav
            ...
            <ScrollView>
                <View style={styles.container}>
                    <View style={styles.header}>
                        <Text style={styles.clubTitle}>Stirling Albion F.C. </Text>
                        <Image style={styles.clubBadgeFormat}
                        resizeMode="contain"
                        source={require("../../../../assets/club-badges/stirling-albion.png")}/>
                    </View>
                    ...
                    <View style={{flexDirection:'row', justifyContent:'space-evenly',borderWidth:1, padding:10,backgroundColor:"red"}}>
                        ...
                        <View style={styles.rightView}>
                            <Text style={{color:'white'}}>Stirling{"\n"}</Text>
                            <Text style={{color:'white'}}>1945{"\n"}</Text>
                            <TouchableOpacity
                                onPress={() => {
                            ...
                            <Text style={{color:'white'}}>Forthbank Performance Centre{"\n"}</Text>
                            <Text style={{color:'white'}}>3,808</Text>
                        </View>
                    </View>
                    ...
                    <View style={{backgroundColor:"red"}}>
                        ...
                        resizeMode="contain"
                        source={require("../../../../assets/google-map-photos/stirling_albion_gm.png")}/>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={{padding:16, borderBottomWidth:1,}}>
                        <TouchableOpacity
                                onPress={() => {
                                  navigation.navigate("StirlingQuery");
                                }}
                              >
