...
export default function Stranraer({ navigation }) {
    return (
        <Layout>
            <TopNav
            ...
            <ScrollView>
                <View style={styles.container}>
                    <View style={styles.header}>
                        <Text style={styles.clubTitle}>Stranraer F.C. </Text>
                        <Image style={styles.clubBadgeFormat}
                        resizeMode="contain"
                        source={require("../../../../assets/club-badges/stranraer.png")}/>
                    </View>
                    ...
                    <View style={{flexDirection:'row', justifyContent:'space-evenly',borderWidth:1, padding:10,backgroundColor:"blue"}}>
                        ...
                        <View style={styles.rightView}>
                            <Text style={{color:'white'}}>Dumfries{"\n"}</Text>
                            <Text style={{color:'white'}}>1870{"\n"}</Text>
                            <TouchableOpacity
                                onPress={() => {
                            ...
                            <Text style={{color:'white'}}>Stair Park{"\n"}</Text>
                            <Text style={{color:'white'}}>4,178</Text>
                        </View>
                    </View>
                    ...
                    <View style={{backgroundColor:"blue"}}>
                        ...
                        resizeMode="contain"
                        source={require("../../../../assets/google-map-photos/stranraer_gm.png")}/>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={{padding:16, borderBottomWidth:1,}}>
                        <TouchableOpacity
                                onPress={() => {
                                  navigation.navigate("StranraerQuery");
                                }}
                              >
