...
export default function KeltyHearts ({ navigation }) {
    return (
        <Layout>
            <TopNav
            ...
            <ScrollView>
                <View style={styles.container}>
                    <View style={styles.header}>
                        <Text style={styles.clubTitle}>Kelty Hearts F.C. </Text>
                        <Image style={styles.clubBadgeFormat}
                        resizeMode="contain"
                        source={require("../../../../assets/club-badges/kelty-hearts.png")}/>
                    </View>
                    ...
                    <View style={{flexDirection:'row', justifyContent:'space-evenly',borderWidth:1, padding:10,backgroundColor:"#800000"}}>
                        ...
                        <View style={styles.rightView}>
                            <Text style={{color:'white'}}>Fife / Kelty{"\n"}</Text>
                            <Text style={{color:'white'}}>1975{"\n"}</Text>
                            <Text style={{color:'white'}}> None{"\n"}</Text>
                            <Text style={{color:'white'}}>New Central Park{"\n"}</Text>
                            <Text style={{color:'white'}}>2,181</Text>
                        </View>
                    </View>
                    ...
                    <View style={{backgroundColor:"#800000"}}>
                        ...
                        resizeMode="contain"
                        source={require("../../../../assets/google-map-photos/kelty_hearts_gm.png")}/>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={{padding:16, borderBottomWidth:1,}}>
                        <TouchableOpacity
                                onPress={() => {
                                  navigation.navigate("KeltyHeartsQuery");
                                }}
                              >
