...
export default function Alloa ({ navigation }) {
    return (
        <Layout>
            <TopNav
            ...
            <ScrollView>
                <View style={styles.container}>
                    <View style={styles.header}>
                        <Text style={styles.clubTitle}>Alloa Athletic </Text>
                        <Image style={styles.clubBadgeFormat}
                        resizeMode="contain"
                        source={require("../../../../assets/club-badges/alloa.png")}/>
                    </View>
                    ...
                    <View style={{flexDirection:'row', justifyContent:'space-evenly',borderWidth:1, padding:10,backgroundColor:"orange"}}>
                        ...
                        <View style={styles.rightView}>
                            <Text style={{color:'black'}}>Clackmannanshire / Alloa{"\n"}</Text>
                            ...
                            <Text style={{color:'black'}}>Indodrill Stadium{"\n"}</Text>
                            <Text style={{color:'black'}}>3,100</Text>
                        </View>
                    </View>
                    ...
                    <View style={{backgroundColor:"orange"}}>
                        ...
                        resizeMode="contain"
                        source={require("../../../../assets/google-map-photos/alloa_gm.png")}/>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={{padding:16, borderBottomWidth:1,}}>
                        <TouchableOpacity
                                onPress={() => {
                                  navigation.navigate("AlloaQuery");
                                }}
                              >
