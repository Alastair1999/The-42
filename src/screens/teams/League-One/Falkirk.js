...
export default function Falkirk ({ navigation }) {
    return (
        <Layout>
            <TopNav
            ...
            <ScrollView>
                <View style={styles.container}>
                    <View style={styles.header}>
                        <Text style={styles.clubTitle}>Falkirk F.C </Text>
                        <Image style={styles.clubBadgeFormat}
                        resizeMode="contain"
                        source={require("../../../../assets/club-badges/falkirk.png")}/>
                    </View>

                    <View style={{flexDirection:'row', justifyContent:'space-evenly',borderWidth:1, padding:10,backgroundColor:"#0B0B45"}}>
                        ...
                        <View style={styles.rightView}>
                            <Text style={{color:'white'}}>Falkirk{"\n"}</Text>
                            ...
                            <Text style={{color:'white'}}>7,937</Text>
                        </View>
                    </View>
                    ...
                    <View style={{backgroundColor:"#0B0B45"}}>
                        ...
                        resizeMode="contain"
                        source={require("../../../../assets/google-map-photos/falkirk_gm.png")}/>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={styles.buttonBackGround}>
                        <Button 
                            ...
                            color="#0B0B45"
                            width={100}
                            onPress={() => Linking.openURL("https://falkirkfc.tickethour.co.uk/")}
                        />
                        <Button 
                            text="Fixtures"
                            color="#0B0B45"
                            width={100}
                            onPress={() => Linking.openURL("https://www.falkirkfc.co.uk/2021/07/02/fixtures//")}
                        />
                        <Button 
                            text="Players"
                            color="#0B0B45"
                            width={100}
                            onPress={() => Linking.openURL("https://www.falkirkfc.co.uk/players/")}
                        />
                    </View>
                    ...
                    <View style={{padding:16, borderBottomWidth:1,}}>
                        <TouchableOpacity
                                onPress={() => {
                                  navigation.navigate("FalkirkQuery");
                                }}
                              >
