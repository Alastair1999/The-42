...
export default function Dunfermline ({ navigation }) {
    return (
        <Layout>
            <TopNav
            ...
            <ScrollView>
                <View style={styles.container}>
                    <View style={styles.header}>
                        <Text style={styles.clubTitle}>Dunfermline Athletic </Text>
                        <Image style={styles.clubBadgeFormat}
                        resizeMode="contain"
                        source={require("../../../../assets/club-badges/dunfermline.png")}/>
                    </View>
                    ...
                    <View style={{flexDirection:'row', justifyContent:'space-evenly',borderWidth:1, padding:10,backgroundColor:"black"}}>
                        ...
                        <View style={styles.rightView}>
                            <Text style={{color:'white'}}>Fife / Dunfermline{"\n"}</Text>
                            <Text style={{color:'white'}}>1885{"\n"}</Text>
                            <TouchableOpacity
                                onPress={() => {
                            ...
                            <Text style={{color:'white'}}>East End Park{"\n"}</Text>
                            <Text style={{color:'white'}}>11,380</Text>
                        </View>
                    </View>
                    ...
                    <View style={{backgroundColor:"black"}}>
                        ...
                        resizeMode="contain"
                        source={require("../../../../assets/google-map-photos/dunfermline_gm.png")}/>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={{padding:16, borderBottomWidth:1,}}>
                        <TouchableOpacity
                                onPress={() => {
                                  navigation.navigate("DunfermlineQuery");
                                }}
                              >
