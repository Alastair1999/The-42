...
export default function QueenOfTheSouth ({ navigation }) {
    return (
        <Layout>
            <TopNav
            ...
            <ScrollView>
                <View style={styles.container}>
                    <View style={styles.header}>
                        <Text style={styles.clubTitle}>Queen of the South F.C. </Text>
                        <Image style={styles.clubBadgeFormat}
                        resizeMode="contain"
                        source={require("../../../../assets/club-badges/queen-of-the-south.png")}/>
                    </View>
                    ...
                    <View style={{flexDirection:'row', justifyContent:'space-evenly',borderWidth:1, padding:10,backgroundColor:"blue"}}>
                        ...
                        <View style={styles.rightView}>
                            ...
                            <Text style={{color:'white'}}>Palmerston Park{"\n"}</Text>
                            <Text style={{color:'white'}}>8,690</Text>
                        </View>
                    </View>
                    ...
                    <View style={{padding:16, borderBottomWidth:1,}}>
                        <TouchableOpacity
                                onPress={() => {
                                  navigation.navigate("QueenOfTheSouthQuery");
                                }}
                              >
