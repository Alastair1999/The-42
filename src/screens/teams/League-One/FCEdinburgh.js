...
export default function FcEdinburgh ({ navigation }) {
    return (
        <Layout>
            <TopNav
            ...
            <ScrollView>
                <View style={styles.container}>
                    <View style={styles.header}>
                        <Text style={styles.clubTitle}>F.C. Edinburgh </Text>
                        <Image style={styles.clubBadgeFormat}
                        resizeMode="contain"
                        // need to add the club badge once its available
                    ...
                    <View style={{flexDirection:'row', justifyContent:'space-evenly',borderWidth:1, padding:10,backgroundColor:"black"}}>
                        ...
                        <View style={styles.rightView}>
                            <Text style={{color:'white'}}>Edinburgh{"\n"}</Text>
                            ...
                            <Text style={{color:'white'}}>Meadowbank Stadium{"\n"}</Text>
                            <Text style={{color:'white'}}>1,940</Text>
                        </View>
                    </View>
                    ...
                    <View style={{backgroundColor:"black"}}>
                        ...
                        resizeMode="contain"
                        source={require("../../../../assets/google-map-photos/fc_edinburgh_gm.png")}/>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={{padding:16, borderBottomWidth:1,}}>
                        <TouchableOpacity
                                onPress={() => {
                                  navigation.navigate("FcEdinburghQuery");
                                }}
                              >
