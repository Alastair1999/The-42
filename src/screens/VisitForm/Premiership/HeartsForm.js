...
export default function HeartsForm({navigation}) {
    ...
    const image=require("../../../../assets/club-badges/hearts.png");
    
    function create() {

        // add data to Hearts collection
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Hearts Visit Submission"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
