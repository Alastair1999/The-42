...
export default function CelticForm({navigation}) {
    ...
    const image=require("../../../../assets/club-badges/celtic.png");
    
    function create() {

        // add data to Aberdeen collection
        addDoc(collection(db, "celtic"), {
            visit: visit,
            fixture: fixture,
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Celtic Visit Submission"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
