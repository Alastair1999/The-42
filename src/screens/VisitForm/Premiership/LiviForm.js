...
export default function LiviForm({navigation}) {
    ...
    const image=require("../../../../assets/club-badges/livingston.png");
    
    function create() {

        // add data to Hibs collection
        addDoc(collection(db, "livingston"), {
            visit: visit,
            fixture: fixture,
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Livingston Visit Submission"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
