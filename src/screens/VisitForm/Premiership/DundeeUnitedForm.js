...
export default function DundeeUnitedForm({navigation}) {
    ...
    const image=require("../../../../assets/club-badges/dundee-united.png");
    
    function create() {

        // add data to Dundee United collection
        addDoc(collection(db, "dundee-united"), {
            visit: visit,
            fixture: fixture,
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Dundee United Visit Submission"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
