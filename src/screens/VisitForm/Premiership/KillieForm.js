...
export default function KillieForm({navigation}) {
    ...
    const image=require("../../../../assets/club-badges/kilmarnock.png");
    
    function create() {

        // add data to Hibs collection
        addDoc(collection(db, "kilmarnock"), {
            visit: visit,
            fixture: fixture,
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Kilmarnock Visit Submission"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
