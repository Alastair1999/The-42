...
export default function HibsForm({navigation}) {
    ...
    const image=require("../../../../assets/club-badges/hibernian.png");
    
    function create() {

        // add data to Hibs collection
        addDoc(collection(db, "hibs"), {
            visit: visit,
            fixture: fixture,
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Hibs Visit Submission"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
