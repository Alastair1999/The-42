...
const FcEdinburghQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const fcEdinburghRef = firebase.firestore().collection("fc-edinburgh");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Fc Edinburgh Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
...
export default FcEdinburghQuery;
