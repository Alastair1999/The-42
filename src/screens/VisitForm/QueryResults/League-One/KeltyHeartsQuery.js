...
const KeltyHeartsQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const keltyHeartsRef = firebase.firestore().collection("kelty-hearts");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Kelty Hearts Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
...
export default KeltyHeartsQuery;
