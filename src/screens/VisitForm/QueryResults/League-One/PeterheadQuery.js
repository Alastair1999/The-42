...
const PeterheadQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const peterheadRef = firebase.firestore().collection("peterhead");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Peterhead Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
