...
const QueenOfTheSouthQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const queenOfTheSouthRef = firebase.firestore().collection("queen-of-the-south");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Queen of the South Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
...
export default QueenOfTheSouthQuery;
