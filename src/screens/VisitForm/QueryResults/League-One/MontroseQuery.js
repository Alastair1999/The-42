...
const MontroseQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const montroseRef = firebase.firestore().collection("montrose");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Montrose Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
