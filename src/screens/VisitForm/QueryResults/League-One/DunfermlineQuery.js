...
const DunfermlineQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const dunfermlineRef = firebase.firestore().collection("dunfermline");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Dunfermline Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
...
export default DunfermlineQuery;
