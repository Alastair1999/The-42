...
const KillieQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const aberdeenRef = firebase.firestore().collection("kilmarnock");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Kilmarnock Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
