...
const AberdeenQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const aberdeenRef = firebase.firestore().collection("aberdeen");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Aberdeen Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
