...
const StJohnstoneQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const stJohnstoneRef = firebase.firestore().collection("st-johnstone");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="St Johnstone Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
...
export default StJohnstoneQuery;
