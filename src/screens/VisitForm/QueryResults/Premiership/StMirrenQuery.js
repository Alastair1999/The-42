...
const StMirrenQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const stMirrenRef = firebase.firestore().collection("st-mirren");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="St Mirren Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
