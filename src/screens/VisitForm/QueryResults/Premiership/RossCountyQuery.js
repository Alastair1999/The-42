...
const RossCountyQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const rossCountyRef = firebase.firestore().collection("ross-county");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Ross County Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
...
export default RossCountyQuery;
