...
const DundeeUnitedQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const aberdeenRef = firebase.firestore().collection("dundee-united");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Dundee Utd Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
...
export default DundeeUnitedQuery;
