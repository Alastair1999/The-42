...
const MotherwellQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const motherwellRef = firebase.firestore().collection("motherwell");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Motherwell Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
...
export default MotherwellQuery;
