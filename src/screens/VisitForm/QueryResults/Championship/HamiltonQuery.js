...
const HamiltonQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const hamiltonRef = firebase.firestore().collection("hamilton");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Hamilton Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
