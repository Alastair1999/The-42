...
const MortonQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const mortonRef = firebase.firestore().collection("greenock-morton");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Greenock Morton Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
