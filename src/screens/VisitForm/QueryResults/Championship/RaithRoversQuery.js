...
const RaithRoversQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const raithRoversRef = firebase.firestore().collection("raith-rovers");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Raith Rovers Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
...
export default RaithRoversQuery;
