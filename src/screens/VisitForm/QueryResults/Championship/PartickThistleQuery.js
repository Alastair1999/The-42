...
const PartickThistleQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const partickThistleRef = firebase.firestore().collection("partickThistle");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Partick Thistle Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
...
export default PartickThistleQuery;
