...
const QueensParkQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const queensParkRef = firebase.firestore().collection("queens-park");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Queens Park Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
...
export default QueensParkQuery;
