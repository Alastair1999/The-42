...
const ArbroathQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const arbroathRef = firebase.firestore().collection("arbroath");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Arbroath Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
