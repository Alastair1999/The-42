...
const CoveRangersQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const coveRangersRef = firebase.firestore().collection("cove-rangers");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Cove Rangers Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
...
export default CoveRangersQuery;
