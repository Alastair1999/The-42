...
const InvernessQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const invernessRef = firebase.firestore().collection("inverness");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Inverness Caledonian Thistle Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
