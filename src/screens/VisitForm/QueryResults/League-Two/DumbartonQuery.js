...
const DumbartonQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const dumbartonRef = firebase.firestore().collection("dumbarton");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Dumbarton Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
