...
const AlbionRoversQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const albionRoversRef = firebase.firestore().collection("albion-rovers");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Albion Rovers Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
...
export default AlbionRoversQuery;
