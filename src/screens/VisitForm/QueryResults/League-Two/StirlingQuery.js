...
const StirlingQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const stirlingRef = firebase.firestore().collection("stirling");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Stirling Albion Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
