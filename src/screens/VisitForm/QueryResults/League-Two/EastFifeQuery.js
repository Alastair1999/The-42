...
const EastFifeQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const eastFifeRef = firebase.firestore().collection("east-fife");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="East Fife Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
