...
const StenhousemuirQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const stenhousemuirRef = firebase.firestore().collection("stenhousemuir");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Stenhousemuir Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
...
export default StenhousemuirQuery;
