...
const BonnyriggRoseQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const bonnyriggRoseRef = firebase.firestore().collection("bonnyrigg-rose");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Bonnyrigg Rose Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
...
export default BonnyriggRoseQuery;
