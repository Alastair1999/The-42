...
const StranraerQuery = ({navigation}) => {

    const [users, setUsers] = useState([]);
    const stranraerRef = firebase.firestore().collection("stranraer");
    ...
    return (
        <Layout>
            <TopNav
                middleContent="Stranraer Previous Visits"
                leftContent={
                    <Ionicons
                        name="chevron-back"
                        size={20}
